...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	public boolean isSingleton() {
		return SCOPE_SINGLETON.equals(scope) || SCOPE_DEFAULT.equals(scope);//"singleton".equals(scope)||"".equals("")。即scope为"singleton"或者不设置scope，默认为""
	}
	...
	public boolean isPrototype() {
		return SCOPE_PROTOTYPE.equals(scope);//将scope声明为"singleton"
	}
